...
<html lang="en" class="no-js">
  ...
  <body class="s-younger_member">
    <main>
      <header><img src="img/email-header-ym-2016.jpg" class="c-HeaderImg"></header>
      <div class="c-Content">
        <?php
        ...
        ?>
        <h1>Remind an ASCE Younger Member Friend to Renew</h1><?php
        ...
        <form id="remindForm" method="post" action="&lt;?php echo $_SERVER['PHP_SELF'];?&gt;">
          ...
          <dl class="o-FlexContainer o-FormField">
            <dt style="padding-top: 0.5rem;" class="o-FormField__Label">
